...
abstract class AppLocalizations {
  ...
  /// No description provided for @pipedApiUrlSub.
  ///
  /// In en, this message translates to:
  /// **'Used for YouTube videos.'**
  String get pipedApiUrlSub;
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'bn', 'de', 'el', 'en', 'es', 'fi', 'fr', 'hi', 'hu', 'id', 'it', 'ko', 'ml', 'nb', 'nl', 'pa', 'pl', 'pt', 'sw', 'tr', 'zh'].contains(locale.languageCode);
