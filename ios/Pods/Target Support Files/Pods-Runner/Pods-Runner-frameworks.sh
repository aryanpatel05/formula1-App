...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HLSCachingReverseProxyServer/HLSCachingReverseProxyServer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/add_2_calendar/add_2_calendar.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/background_downloader/background_downloader.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/river_player/river_player.framework"
